package com.unifacef.rentalapi.gateways.outputs.mongodb.documents;
...
@NoArgsConstructor
@Document("locacoes")
public class LocacaoDocument implements Serializable {	
...
//	@ApiModelProperty(dataType = "java.util.Date")
	...
	public LocacaoDocument(final Locacao locacao) {
